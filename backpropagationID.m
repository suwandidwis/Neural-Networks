function [finalerror,v,w,v0,w0,Y,epoch] = backpropagationID(u_k,y_k,alpha,lh,momentum)
...
while MSSE > 0.00001
    ...
    MSSE=sum(error)/N
    time=toc
    save('Input_NNID20.mat','x','t','alpha','lh','momentum');
    save('Hasil_NNID20.mat','MSSE','errortotal','v','w','v0','w0','v1','w1','v00','w00','Y','epoch','time');
end
